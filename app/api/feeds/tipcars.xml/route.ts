...
import { generateTipCarsFeed, ExportableListing } from "@/lib/listing-export";
...
export async function GET() {
  try {
    ...
    const xml = generateTipCarsFeed(exportable);
    ...
    console.error("GET /api/feeds/tipcars.xml error:", error);
