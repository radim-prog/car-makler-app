...
import { generateSautoFeed, ExportableListing } from "@/lib/listing-export";
...
export async function GET() {
  try {
    ...
    const xml = generateSautoFeed(exportable);
    ...
    console.error("GET /api/feeds/sauto.xml error:", error);
