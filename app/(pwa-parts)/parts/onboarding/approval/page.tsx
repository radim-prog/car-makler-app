...
export default function SupplierOnboardingApprovalPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-lg mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 h-0.5 bg-green-500 rounded-full" />
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full bg-green-500 text-white flex items-center justify-center text-xs font-bold">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
                  <path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" />
      ...
      <div className="max-w-lg mx-auto px-4 py-12 text-center">
        <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-green-50">
          <svg className="w-12 h-12 text-green-500 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6 text-left max-w-sm mx-auto">
          ...
          <ul className="space-y-2.5">
            <li className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-xs font-bold shrink-0 mt-0.5">1</div>
              <span className="text-sm text-gray-600">Zkontrolujeme vaše dokumenty</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-xs font-bold shrink-0 mt-0.5">2</div>
              <span className="text-sm text-gray-600">Ověříme údaje o firmě</span>
            </li>
            <li className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-xs font-bold shrink-0 mt-0.5">3</div>
              <span className="text-sm text-gray-600">Aktivujeme váš účet a budete moci přidávat díly</span>
            </li>
          </ul>
        </div>
        ...
        <p className="text-sm text-gray-500 mb-4">
          ...
          <a href="mailto:podpora@carmakler.cz" className="text-green-600 font-medium">
