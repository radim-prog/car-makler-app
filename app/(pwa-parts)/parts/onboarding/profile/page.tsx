...
export default function SupplierOnboardingProfilePage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (res.ok) {
        router.push("/parts/onboarding/documents");
      } else {
        ...
        <div className="max-w-lg mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-full bg-green-500 text-white flex items-center justify-center text-xs font-bold">1</div>
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-5">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Vyplňte základní údaje o vaší firmě
          </p>
        </div>
        ...
        <Input
          ...
          placeholder="např. Auto Kelly s.r.o."
        />
